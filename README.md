[![Build status](https://ci.appveyor.com/api/projects/status/9fehxk2wxmx8nsa3?svg=true)](https://ci.appveyor.com/project/stueber/doc-magellan6-import-de)

# MAGELLAN 6 Importschnittstelle

Dies ist die deutsche Dokumentation zur Importschnittstelle von MAGELLAN 6. Die Dokumentation ist Open Source und wir haben sie mit [GitBook](https://github.com/GitbookIO/gitbook) realisiert.
...
1. Erstelle einen lokalen Ordner für die Dokumentation, z.B. `c:\docs\magellan6-import`.

2. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\magellan6-import`.

3. Tippe den Befehl `git clone https://github.com/stuebersystems/doc.magellan6-import.de.git` ein, um das Repository zu klonen.
...
1. Öffne die URL `https://github.com/stuebersystems/doc.magellan6-import.de` in deinem Webbrowser

2. Klicke auf die Schaltfläche `Clone or download` und dann auf `Download ZIP`.

3. Entpacke das Zip-Archiv in einen lokalen Ordner Deiner Wahl, z.B. `c:\docs\magellan6-import`.
...
1. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\magellan6-import\src`.
...
4. Um Dir das Ergebnis anzeigen zu lassen, wechsle in den Ordner `c:\docs\magellan6-import\src\_book` und öffne die Datei `index.html` in Deinem Webbrowser.
