...
---|---
[schulen.import.csv](/MagImp/schnittstellenformat_schulenimportcsv.md)|Enthält die Stammdaten der Schulen
[betriebe.import.csv](/MagImp/betriebeimportcsv.md)|Enthält die Stammdaten der Betriebe
[lehrer.import.csv](/MagImp/lehrerimportcsv.md)|Enthält die Stammdaten der Lehrer
[schueler.import.csv](/MagImp/lehrerimportcsv.md)|Enthält die Stammdaten der Schüler und Bewerber
[sorgebe.import.csv](/MagImp/sorgebeimportcsv.md)|Enthält die Stammdaten der Sorgeberechtigten
[verlage.import.csv](/MagImp/verlageimportcsv.md)|Enthält die Stammdaten der Verlage
[lieferanten.import.csv](/MagImp/lieferantenimportcsv.md)|Enthält die Stammdaten der Lieferanten
[medien.import.csv](/MagImp/lieferantenimportcsv.md)|Enthält die Stammdaten der Medien
...
Importdatei|Beschreibung
---|---
[exemplare.import.csv](/MagImp/exemplareimportcsv.md)|Enthält die Exemplardaten zu den Medien<br/>Bedingung:<br/> Import der medien.import.csv
[klassen.import.csv](/MagImp/klassenimportcsv.md)	|Enthält die Stamm- und Zeitraumdaten der Klassen<br/>Bedingung: <br/>Vorhandensein der Zeiträume und Lehrer (Verweis auf Klassenleiter) in MAGELLAN.
[schueler_laufbahn.import.csv](/MagImp/schuelerlaufbahn_importcsv.md) |Enthält die Laufbahndaten der Schüler <br/>Weitere Bedingung: <br/>Import der klassen.import.csv und schueler.import.csv
[schueler_fachdaten.import.csv](/MagImp/schuelerfachdatenimportcsv.md) |	Enthält die Fachdaten der Schüler<br/>Weitere Bedingung:<br/> Import der klassen.import.csv, schueler.import.csv und schueler_laufbahn.import.csv
[schueler_sorgebe.import.csv](/MagImp/schuelersorgebeimportcsv.md)|Enthält die Zuordnung der Sorgeberechtigten zu den Schülern<br/>Weitere Bedingung:<br/> Import der schueler.import.csv und sorgebe.import.csv
[schueler_schulen.import.csv](/MagImp/schuelerschulenimportcsv.md)|	Enthält die bereits besuchten Schulen der Schüler (Stichwort: Herkunftsschulen)<br/>Weitere Bedingung:<br/> Import der schueler.import.csv und schulen.import.csv
[schueler_ausbildung.import.csv](/MagImp/schuelerausbildungimportcsv.md)|Enthält die Ausbildungsdaten der Schüler<br/>Weitere Bedingung:<br/> Import der schueler.import.csv und betriebe.import.csv
...
Wie Sie die Schlüsselverzeichnisse Ihres Bundeslandes nach Magellan einlesen, entnehmen Sie bitte dem Abschnitt [Schlüsselverzeichnisse importieren](https://doc.magellan6.stueber.de/admin/import-export.html#schlüsselverzeichnisse-importieren) der allgemeinen [MAGELLAN-Dokumentation](https://doc.magellan6.stueber.de/).
...
Die Importschnittstelle besteht aus Importdateien, die in einer festgelegten Semantik vorliegen müssen. Im folgenden Abschnitt wird erklärt, wie die Importdateien genau auszusehen haben und welche Felder vorhanden sein müssen, damit der Import korrekt durchlaufen kann. Die Verwendung des Import-Format-Assistenten beschreiben wir im Abschnitt ["Importieren mit dem Importassistenten"](https://doc.magellan6-import.stueber.de/MagImp/importieren_mit_dem_importassistenten.html).

## Schnittstellenformate


* [schulen.import.csv](https://doc.magellan6-import.stueber.de/MagImp/schnittstellenformat_schulenimportcsv.html)
* [betriebe.import.csv](https://doc.magellan6-import.stueber.de/MagImp/betriebeimportcsv.html)
* [lehrer.import.csv](https://doc.magellan6-import.stueber.de/MagImp/lehrerimportcsv.html)	
* [schueler.import.csv](https://doc.magellan6-import.stueber.de/MagImp/schuelerimportcsv.html)
* [sorgebe.import.csv](https://doc.magellan6-import.stueber.de/MagImp/sorgebeimportcsv.html)	
* [verlage.import.csv](https://doc.magellan6-import.stueber.de/MagImp/verlageimportcsv.html)
* [lieferanten.import.csv](https://doc.magellan6-import.stueber.de/MagImp/lieferantenimportcsv.html)	
* [medien.import.csv](https://doc.magellan6-import.stueber.de/MagImp/medienimportcsv.html)
* [exemplare.import.csv](https://doc.magellan6-import.stueber.de/MagImp/exemplareimportcsv.html)	
* [klassen.import.csv](https://doc.magellan6-import.stueber.de/MagImp/klassenimportcsv.html)
* [schueler_laufbahn.import.csv](https://doc.magellan6-import.stueber.de/MagImp/schuelerlaufbahn_importcsv.html)
* [schueler_fachdaten.import.csv](https://doc.magellan6-import.stueber.de/MagImp/schuelerfachdatenimportcsv.html)
* [schueler_sorgebe.import.csv](https://doc.magellan6-import.stueber.de/MagImp/schuelersorgebeimportcsv.html)
* [schueler_schulen.import.csv](https://doc.magellan6-import.stueber.de/MagImp/schuelerschulenimportcsv.html)
* [schueler_ausbildung.import.csv](https://doc.magellan6-import.stueber.de/MagImp/schuelerausbildungimportcsv.html)
